 ...
 */
class Sc3_Prof_SC_B5_2430_DTP_less extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "Sc_Prof_B5_2430_DTP_date_less_1")
    void copyClaimsToConnectors() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc_Prof_B5_2430_DTP_date_less_1/837_Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Prof_B5_2430_DTP_date_less_1/837_Claim.xml doesn't exist!")
        ...
        def TC1b = new File(testDataPath + "/Sc_Prof_B5_2430_DTP_date_less_1/837_Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc_Prof_B5_2430_DTP_date_less_1/837_Claim.xml.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors", groups = "Sc_Prof_B5_2430_DTP_date_less_1", alwaysRun = true)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "Sc_Prof_B5_2430_DTP_date_less_1", alwaysRun = true)
    void checkClaimID() {
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Prof_B5_2430_DTP_date_less_1/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Prof_B5_2430_DTP_date_less_1/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc_Prof_B5_2430_DTP_date_less_1/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc_Prof_B5_2430_DTP_date_less_1/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "Sc_Prof_B5_2430_DTP_date_less_1", alwaysRun = true)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "Sc_Prof_B5_2430_DTP_date_less_1", alwaysRun = true)
...
//        sleep(sleepTime)
        ...
        Assert.assertEquals(cf7, "R8358", "There should be Custom field for CMSContractID with GroupIdentifier =" + cf7)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "Sc_Prof_B5_2430_DTP_date_less_1", alwaysRun = true)
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_Prof_B5_2430_DTP_date_less_1.dat"));
