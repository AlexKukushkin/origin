 ...
 */
class ChargeAmount extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "ChargeAmount", alwaysRun = true)
    void copyClaimsToConnectors() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "ChargeAmount_151877/837_1.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "ChargeAmount_151877/837_1.dat doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors", groups = "ChargeAmount", alwaysRun = true)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "ChargeAmount", alwaysRun = true)
    void checkClaimID() {
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "ChargeAmount_151877/835_1.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "ChargeAmount_151877/857_1.dat doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "ChargeAmount_151877/835_1.dat.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "ChargeAmount_151877/835_1.dat.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "ChargeAmount_151877", alwaysRun = true)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "ChargeAmount_151877", alwaysRun = true)
...
//        sleep(sleepTime)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "ChargeAmount_151877", alwaysRun = true)
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_ChargeAmount.dat"));
