...
class Sc9_Cas_ServiceAdjustment extends UtilsQuery {
    ...
    void copyClaimsToConnectors1() {
        ...
        def TC1a = new File(testDataPath + "CAS_9_ServiceAdjustment/1/Claim_1.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "CAS_9_ServiceAdjustment/1/Claim_1.xml doesn't exist!")
...
/*        GlobalVar.n1 = randomNumber;
        ...
        def TC1b = new File(testDataPath + "/CAS_9_ServiceAdjustment/1/Claim_1.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/CAS_9_ServiceAdjustment/1/Claim_1.xml.properties doesn't exist!")
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "CAS_9_ServiceAdjustment/1/Payment_1.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "CAS_9_ServiceAdjustment/1/Payment_1.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/CAS_9_ServiceAdjustment/1/Payment_1.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/CAS_9_ServiceAdjustment/1/Payment_1.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(30000)
    ...
    void copyClaimsToConnectors2() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "CAS_9_ServiceAdjustment/2/Claim_2.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "CAS_9_ServiceAdjustment/2/Claim_2.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/CAS_9_ServiceAdjustment/2/Claim_2.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/CAS_9_ServiceAdjustment/2/Claim_2.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors2() {
        currentEncTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "CAS_9_ServiceAdjustment/2/Payment_2.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "CAS_9_ServiceAdjustment/2/Payment_2.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/CAS_9_ServiceAdjustment/2/Payment_2.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/CAS_9_ServiceAdjustment/2/Payment_2.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(sleepTime)
    ...
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_CASServiceAdjustment.dat"));
