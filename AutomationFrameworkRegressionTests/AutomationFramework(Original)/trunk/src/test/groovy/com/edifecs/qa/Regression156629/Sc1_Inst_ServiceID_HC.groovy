 ...
 */
class Sc1_Inst_ServiceID_HC extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "ScenarioInst_ServiceID_HC", alwaysRun = true)
    void copyClaimsToConnectors() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "ScenarioInst_ServiceID_HC/837_2016.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "ScenarioInst_ServiceID_HC/837_2016.dat doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors", groups = "ScenarioInst_ServiceID_HC", alwaysRun = true)
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "ScenarioInst_ServiceID_HC/835_2016.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "ScenarioInst_ServiceID_HC/857_2016.dat doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "ScenarioInst_ServiceID_HC/835_2016.dat.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "ScenarioInst_ServiceID_HC/835_2016.dat.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "ScenarioInst_ServiceID_HC", alwaysRun = true)
...
//        sleep(sleepTime)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "ScenarioInst_ServiceID_HC", alwaysRun = true)
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_Inst_HC.dat"));
