...
/**
 * Created by c-alexcucu on 9/15/2016.
 */
...
class Sc6_Inst_SC_B5_2320_DTP_more extends UtilsQuery {
...
//    def encTransmissionSID
    ...
    void copyClaimsToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/837_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/837_Inst.dat doesn't exist!")
...
//        sleep(60000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/835_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/857_Inst.dat doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/835_Inst.dat.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "Sc_Inst_B5_2320_DTP_date_more_2/835_Inst.dat.properties doesn't exist!")
...
//        sleep 30000
        ...
        claimID.each {
            ...
            } else
            {
                println()
                println("==========================================================")
                println("Compliance rejection during creation of outbound encounter.")
                println("The compliance exception is expected. The test is passed.")
                println("==========================================================")
                println()
            }
        }
