...
class Sc11_SubscriberInfo extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    void copyClaimsToConnectors1() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/1/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/1/Claim.xml doesn't exist!")
...
/*        GlobalVar.n1 = randomNumber;
        ...
        def TC1b = new File(testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/1/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/1/Claim.xml.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors1", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID1", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    void checkClaimID() {
    ...
    @Test(dependsOnMethods = "checkClaimID", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep 30000
    ...
    @Test(dependsOnMethods = "checkGroupIdentifiers", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/1/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/1/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/1/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/1/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep(30000)
    ...
    void copyClaimsToConnectors2() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/2/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/2/Claim.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/2/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/2/Claim.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors2", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors2", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    void checkClaimID2() {
        trackingIdentifier = getCorrelationIDWaiting("302", "SubmittedClaimID", currentTransmissionSID)
        Assert.assertNotNull(trackingIdentifier, "There is no ExternalCorrelationIdValue for TransmissionSID = " + currentTransmissionSID)
    ...
    @Test(dependsOnMethods = "checkClaimID2", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    ...
    void copyPaymentToConnectors2() {
        currentEncTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/2/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc11(OriginalClaim_SubscriberInfo)/2/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/2/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc11(OriginalClaim_SubscriberInfo)/2/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "Sc11(OriginalClaim_SubscriberInfo)")
...
//        sleep(sleepTime)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "Sc11(OriginalClaim_SubscriberInfo)")
    ...
    @Test(dependsOnMethods = "checkCurrentActivityState5", groups = "Sc11(OriginalClaim_SubscriberInfo)", alwaysRun = true)
