...
class Sc7_Prof_SC_B5_2430_DTP_more extends UtilsQuery {
...
//    def encTransmissionSID
    ...
    void copyClaimsToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Prof_B5_2430_DTP_date_more_1/837_Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Prof_B5_2430_DTP_date_more_1/837_Claim.xml doesn't exist!")
...
/*        GlobalVar.n1 = randomNumber;
        ...
        def TC1b = new File(testDataPath + "/Sc_Prof_B5_2430_DTP_date_more_1/837_Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc_Prof_B5_2430_DTP_date_more_1/837_Claim.xml.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "Sc_Prof_B5_2430_DTP_date_more_1", alwaysRun = true)
...
//        sleep(60000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Prof_B5_2430_DTP_date_more_1/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Prof_B5_2430_DTP_date_more_1/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc_Prof_B5_2430_DTP_date_more_1/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc_Prof_B5_2430_DTP_date_more_1/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
