 ...
 */
class ProfDatCurrentActivityState extends UtilsQuery {
...
//        sleep 60000
    ...
    void copy277ToConnectors() {
        ...
        def binding = ["OriginatorTranIdentifier": origTranIdent, "UniqueID2": randomNr3, "TargetTrackingID": trackingIdentifier, "ID": randomNr, "UniqueID": randomNumber]
        def engine = new GStringTemplateEngine()
        def template = engine.createTemplate(text).make(binding)
