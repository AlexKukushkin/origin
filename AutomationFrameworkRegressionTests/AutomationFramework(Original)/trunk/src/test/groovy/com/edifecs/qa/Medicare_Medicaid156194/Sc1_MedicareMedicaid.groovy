...
class Sc1_MedicareMedicaid extends UtilsQuery {
    ...
    void copyClaimsToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc1_Medicare_Medicaid_1MC16/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc1_Medicare_Medicaid_1MC16/Claim.xml doesn't exist!")
        ...
        def TC1b = new File(testDataPath + "/Sc1_Medicare_Medicaid_1MC16/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc1_Medicare_Medicaid_1MC16/Claim.xml.properties doesn't exist!")
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc1_Medicare_Medicaid_1MC16/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc1_Medicare_Medicaid_1MC16/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc1_Medicare_Medicaid_1MC16/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc1_Medicare_Medicaid_1MC16/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(sleepTime)
    ...
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_MedicareMedicaid_1MC16.dat"));
