...
class Sc3_MedicareMedicaid extends UtilsQuery {
    ...
    void copyClaimsToConnectors() {
        ...
        def TC1a = new File(testDataPath + "NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Claim.xml doesn't exist!")
        ...
        def TC1b = new File(testDataPath + "/NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Claim.xml.properties doesn't exist!")
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/NewFolder/Sc3_Medicare_Medicaid_twoMC_one16/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(sleepTime)
    ...
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_MedicareMedicaid_twoMC_one16.dat"));
