 ...
 */
class Sc5_Inst_SC_B5_2430_DTP_more extends UtilsQuery {
...
//    def encTransmissionSID
    ...
    void copyClaimsToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/837_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/837_Inst.dat doesn't exist!")
...
//        sleep(60000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/835_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/857_Inst.dat doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/835_Inst.dat.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_more_1/835_Inst.dat.properties doesn't exist!")
