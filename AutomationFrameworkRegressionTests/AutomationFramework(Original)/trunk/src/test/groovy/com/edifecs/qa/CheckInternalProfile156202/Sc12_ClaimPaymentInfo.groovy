...
class Sc12_ClaimPaymentInfo extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    void copyClaimsToConnectors1() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/1/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/1/Claim.xml doesn't exist!")
...
/*        GlobalVar.n1 = randomNumber;
        ...
        def TC1b = new File(testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/1/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/1/Claim.xml.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors1", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID1", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    void checkClaimID() {
    ...
    @Test(dependsOnMethods = "checkClaimID", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep 30000
    ...
    @Test(dependsOnMethods = "checkGroupIdentifiers", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/1/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/1/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/1/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/1/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep(30000)
    ...
    void copyClaimsToConnectors2() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/2/Claim.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/2/Claim.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/2/Claim.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/2/Claim.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors2", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors2", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    void checkClaimID2() {
        trackingIdentifier = getCorrelationIDWaiting("302", "SubmittedClaimID", currentTransmissionSID)
        Assert.assertNotNull(trackingIdentifier, "There is no ExternalCorrelationIdValue for TransmissionSID = " + currentTransmissionSID)
    ...
    @Test(dependsOnMethods = "checkClaimID2", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    ...
    void copyPaymentToConnectors2() {
        currentEncTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/2/Payment.xml")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc12(OriginalClaim_ClaimPaymentInfo)/2/Payment.xml doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/2/Payment.xml.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "/Sc12(OriginalClaim_ClaimPaymentInfo)/2/Payment.xml.properties doesn't exist!")
        def text2 = TC1b.getText()
        def template2 = engine.createTemplate(text2).make(binding)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
...
//        sleep(sleepTime)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)")
    ...
    @Test(dependsOnMethods = "checkCurrentActivityState5", groups = "Sc12(OriginalClaim_ClaimPaymentInfo)", alwaysRun = true)
