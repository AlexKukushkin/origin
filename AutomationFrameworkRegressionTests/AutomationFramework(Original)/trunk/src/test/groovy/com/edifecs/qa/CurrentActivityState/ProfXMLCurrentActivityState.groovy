 ...
 */
class ProfXMLCurrentActivityState extends UtilsQuery {
...
//        sleep 60000
    ...
    void copy277ToConnectors() {
        ...
        def binding = ["OriginatorTranIdentifier": origTranIdent, "TargetTrackingID": trackingIdentifier, "ID": randomNr, "UniqueID2": randomNr3, "UniqueID": randomNumber]
        def engine = new GStringTemplateEngine()
        def template = engine.createTemplate(text).make(binding)
