 ...
 */
class Sc1_Inst_SC_B5_2430_DTP_less extends UtilsQuery {
    ...
    @Test(dependsOnMethods = "checkIfFileConnectorsExist", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
    void copyClaimsToConnectors() {
        currentTimeSQLFormat = createCurrentTimeSQLFormat()
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/837_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/837_Inst.dat doesn't exist!")
...
/*        def TC1b = new File(testDataPath + "ScenarioInst_ServiceID_HC/837_2016.dat.properties")
    ...
    @Test(dependsOnMethods = "copyClaimsToConnectors", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getClaimTransmissionSID", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
    void checkClaimID() {
...
//        sleep(30000)
    ...
    void copyPaymentToConnectors() {
        ...
        def TC1a = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/835_Inst.dat")
        Assert.assertTrue(TC1a.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/857_Inst.dat doesn't exist!")
        def text = TC1a.getText()
        ...
        def TC1b = new File(testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/835_Inst.dat.properties")
        Assert.assertTrue(TC1b.exists(), testDataPath + "Sc_Inst_B5_2430_DTP_date_less_1/835_Inst.dat.properties doesn't exist!")
    ...
    @Test(dependsOnMethods = "copyPaymentToConnectors", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
...
//        sleep(30000)
    ...
    @Test(dependsOnMethods = "getEncounterClaimTransmissionSID", groups = "Sc_Inst_B5_DTP_date_less_1", alwaysRun = true)
...
//        sleep(sleepTime)
    ...
    @Test(dependsOnMethods = "checkEncounterCustomFields", groups = "Sc_Inst_B5_2430_DTP_date_less_1", alwaysRun = true)
    void validateAttachment() {
        FileInputStream firstTargetFile = new FileInputStream(new File("./src/test/resources/com/edifecs/qa/Validation/Assertion_B5_2430_DTP_date_less_1.dat"));
